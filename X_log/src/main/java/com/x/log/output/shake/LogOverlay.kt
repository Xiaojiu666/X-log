...
class LogOverlay(private val order: Order) : ShakeDetector.ShakeListener, Application.ActivityLifecycleCallbacks {
    ...
    private fun showChooserDialog(context: Activity, shaker: ShakeProducer? = null) {
        ...
        val arrayAdapter = ArrayAdapter<String>(context, R.layout.simple_selectable_list_item)
        arrayAdapter.apply {
...
//                    }
//                }
//                POSITION_SHARE_LOG_FILE -> MBLoggerKit.loadCurrentLog().shareAsFile(context, "${
//                    SimpleDateFormat(LOG_PATTERN, Locale.getDefault()).format(
